...
class GuidanceParams(ParamGroup):
    def __init__(self, parser, opts=None):
        ...
        # others
        self.inverse_guidance_scale = 1.0
        self.time_schedule = "uniform"
        self.sample_method = "euler"
        self.inverse_steps = 3
        self.train_step_method = "couple"
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser, opts=None):
        ...
        # others
        self.opacity_reset_from_iter = 500
        super().__init__(parser, "Optimization Parameters")


class GenerateCamParams(ParamGroup):
    def __init__(self, parser):
        self.init_shape = 'pointe'
        self.init_prompt = ''      
