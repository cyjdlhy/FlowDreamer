...
class GaussianModel:
    ...
    #     # 给定矩阵 R1 和 R3
    #     R1 = np.array([[ 0.98642572,  0.00330009,  0.16417496],
    #                 [ 0.04206572,  0.96135725, -0.27207114],
    #                 [-0.15872865,  0.27528411,  0.9481687 ]])

    #     R3 = np.array([[-1.000000e+00, -0.000000e+00, -0.000000e+00],
    ...
    #     # xyz = np.stack((np.asarray(plydata.elements[0]["y"]),
    #     #                 np.asarray(plydata.elements[0]["x"]),
    #     #                 -np.asarray(plydata.elements[0]["z"])),  axis=1)


    #     # # 定义旋转角度
    #     theta = np.radians(30)  # 45度角
